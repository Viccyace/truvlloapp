...
const styles = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .auth-logo {
    ...
    font-family: 'Playfair Display', serif; font-size: 1.5rem; font-weight: 700; color: var(--white);
  ...
  .auth-left-headline {
    ...
    font-size: 2.6rem; font-weight: 900; line-height: 1.12;
    color: var(--white); letter-spacing: -0.02em; margin-bottom: 20px;
  }
  ...
  .stat-item {}
  .stat-val {
    font-family: 'Playfair Display', serif; font-size: 1.8rem; font-weight: 900; color: var(--white);
  }
  .stat-label { font-size: 0.78rem; color: rgba(255,255,255,0.35); font-weight: 500; margin-top: 2px; }

  .auth-testimonial {
    background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.08);
    border-radius: 18px; padding: 24px; position: relative; z-index: 1;
  }
  .auth-quote-mark {
    font-family: 'Playfair Display', serif; font-size: 3rem; line-height: 0.6;
    color: var(--amber); opacity: 0.6; margin-bottom: 12px; display: block;
  }
  .auth-testimonial-text {
    font-size: 0.9rem; color: rgba(255,255,255,0.65); line-height: 1.65;
    font-family: 'Playfair Display', serif; font-style: italic; margin-bottom: 16px;
  }
  ...
  .auth-right {
    ...
    padding: 48px 5%; background: var(--cream); min-height: 100vh;
    overflow-y: auto;
  }
  ...
  .auth-mobile-logo {
    ...
    font-family: 'Playfair Display', serif; font-size: 1.4rem; font-weight: 700; color: var(--ink);
    margin-bottom: 36px;
  }
  ...
  /* TAB SWITCHER */
  .auth-tabs {
    display: flex; background: var(--cream-dark); border-radius: 14px; padding: 4px;
  ...
  .auth-tab {
    ...
    cursor: pointer; transition: all 0.22s; background: transparent; color: var(--ink-subtle);
  }
  .auth-tab.active {
  ...
  .field-label {
    display: block; font-size: 0.8rem; font-weight: 600; color: var(--ink-muted);
  ...
  .divider {
    ...
    font-size: 0.8rem; color: rgba(10,10,10,0.3); font-weight: 500;
  }
  ...
  .terms-text {
    font-size: 0.78rem; color: var(--ink-subtle); text-align: center; line-height: 1.6;
    margin-top: 8px;
  }
  .terms-text a { color: var(--green-mid); font-weight: 600; text-decoration: none; }

  .switch-text {
    text-align: center; font-size: 0.875rem; color: var(--ink-subtle); margin-top: 24px;
  }
  .switch-text a { color: var(--green-mid); font-weight: 700; text-decoration: none; cursor: pointer; }

  /* Trial callout */
  .trial-callout {
    background: var(--green-pale); border-radius: 12px; padding: 14px 16px;
...
function LoginForm({ onSwitch }) {
  ...
  return (
    <>
      ...
      <p className="auth-form-sub">Sign in to your Truvllo account and pick up where you left off.</p>
      ...
      <div className="field-wrap">
        ...
        <input
          ...
          value={email} onChange={e => { setEmail(e.target.value); setErrors(x => ({ ...x, email: "" })); }}
        />
      ...
      <div className="field-wrap">
        ...
        <div className="password-wrap">
          <input
            ...
            type={showPassword ? "text" : "password"} placeholder="Enter your password" autoComplete="current-password"
            value={password} onChange={e => { setPassword(e.target.value); setErrors(x => ({ ...x, password: "" })); }}
          />
          <button className="password-toggle" onClick={() => setShowPassword(v => !v)} type="button">
    ...
    return (
      <div className="success-screen">
        ...
        <p className="success-sub">
          Welcome to Truvllo, {firstName}. Check your inbox to verify your email, then we'll get your budget set up.
        </p>
      </div>
    );
  }
    ...
    <>
      ...
      <div className="trial-callout">
        ...
        <div className="trial-callout-text">
          <strong>7-day Premium trial included</strong> — unlocks automatically when you log your first expense. No card needed.
        </div>
      </div>
      ...
      <div className="form-row">
        <div className="field-wrap">
          ...
          <input
            ...
            type="text" placeholder="Adaeze" autoComplete="given-name"
        ...
        <div className="field-wrap">
          ...
          <input
            ...
            type="text" placeholder="Okafor" autoComplete="family-name"
      ...
      <div className="field-wrap">
        ...
        <div className="password-wrap">
          <input
            ...
            type={showConfirm ? "text" : "password"} placeholder="Re-enter password" autoComplete="new-password"
            value={confirmPassword} onChange={e => { setConfirmPassword(e.target.value); clearErr("confirmPassword"); }}
          />
          <button className="password-toggle" onClick={() => setShowConfirm(v => !v)} type="button">
      ...
      <div className="field-wrap" style={{ marginBottom: 22 }}>
        <label className="checkbox-wrap">
          <input type="checkbox" checked={agreeTerms} onChange={e => { setAgreeTerms(e.target.checked); clearErr("terms"); }} />
        ...
        {errors.terms && <div className="field-error" style={{ marginTop: 6 }}>{errors.terms}</div>}
      </div>
    ...
    <div className="auth-left">
      ...
      <div className="auth-left-center">
        <h2 className="auth-left-headline">
          {mode === "login"
            ? <>Your money is<br /><em>waiting for you</em></>
            : <>Take control of<br /><em>your finances today</em></>
          }
        </h2>
        <p className="auth-left-sub">
          {mode === "login"
            ? "Welcome back. Your budget, pace, and AI insights are right where you left them."
            : "Join 2,400+ young professionals in Nigeria tracking their money smarter with Truvllo."
          }
        </p>
        <div className="auth-left-stats">
          ...
          <div className="stat-item">
            <div className="stat-val">₦2.1B</div>
      ...
      <div className="auth-testimonial">
        ...
        <p className="auth-testimonial-text">
          The AI spending coach saved me ₦40k last month. It spotted I was overspending on food delivery before I even noticed.
        </p>
        <div className="auth-testimonial-author">
          <div className="auth-testimonial-avatar">K</div>
          <div>
            <div className="auth-testimonial-name">Korede F.</div>
            <div className="auth-testimonial-role">Software Engineer, Abuja</div>
          </div>
        </div>
      </div>
    </div>
