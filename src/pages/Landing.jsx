...
const styles = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .nav-links a {
    color: var(--ink-subtle); text-decoration: none; font-size: 0.875rem;
  ...
  /* ── HERO ─────────────────────────────────────────────────────────────── */
  /* Vaultify layout: big headline left-centered, phone image right, CTA buttons below */
  .hero {
  ...
  .hero-eyebrow {
    ...
    margin-bottom: 28px; border: 1px solid rgba(27,67,50,0.15);
  }
  ...
  .hero-sub {
    font-size: 1.1rem; color: var(--ink-subtle);
  ...
  .btn-primary {
    ...
    cursor: pointer; transition: all 0.2s; box-shadow: 0 4px 16px rgba(27,67,50,0.25);
  }
  ...
  /* Hero right — phone image placeholder */
  .hero-right {
  ...
  .hero-phone-slot {
    ...
    background: linear-gradient(135deg, var(--cream-dark) 0%, rgba(64,145,108,0.08) 100%);
    border-radius: 32px; border: 2px dashed rgba(27,67,50,0.2);
    display: flex; flex-direction: column; align-items: center; justify-content: center;
    gap: 12px; color: var(--ink-subtle); font-size: 0.875rem; font-weight: 500;
    position: relative; overflow: hidden;
  }
  .hero-phone-slot::before {
    content: ''; position: absolute; inset: 0;
    background: radial-gradient(circle at 60% 40%, rgba(64,145,108,0.12) 0%, transparent 60%);
  }
  ...
  /* Vaultify: grey band with 4 stats across */
  .stats-strip {
    background: var(--cream-dark); padding: 60px 6%;
    border-top: 1px solid var(--border); border-bottom: 1px solid var(--border);
  }
  .stats-inner {
    max-width: 1200px; margin: 0 auto;
    display: grid; grid-template-columns: 1fr 1fr 1fr 1fr; gap: 40px; align-items: center;
  }
  ...
  /* ── FEATURES SECTION ─────────────────────────────────────────────────── */
  /* Vaultify: headline + subtitle center, 3-col card grid below */
  .features-section { padding: 100px 6%; background: var(--white); }
  .section-header { text-align: center; margin-bottom: 64px; }
  .section-label {
    display: inline-block; font-size: 0.75rem; font-weight: 700;
    letter-spacing: 0.12em; text-transform: uppercase; color: var(--green-mid); margin-bottom: 14px;
  }
  .section-headline {
    font-family: 'Playfair Display', serif; font-size: clamp(2rem, 4vw, 3rem);
    font-weight: 800; line-height: 1.15; letter-spacing: -0.015em; color: var(--ink);
  }
  ...
  /* ── HOW IT WORKS ─────────────────────────────────────────────────────── */
  /* Vaultify: 2-col — steps list left, big bold text right */
  ...
  .how-headline {
    ...
    font-weight: 900; line-height: 1.1; letter-spacing: -0.02em; margin-bottom: 24px;
  }
  ...
  /* ── PRICING ──────────────────────────────────────────────────────────── */
  /* Vaultify: 3 cards — free, featured pro, enterprise */
  .pricing-section { padding: 100px 6%; background: var(--white); }
  .pricing-toggle {
    display: inline-flex; background: var(--cream-dark); border-radius: 10px;
    padding: 4px; gap: 4px; margin: 32px auto 0; display: flex; justify-content: center;
  }
  .pricing-toggle button {
    ...
    color: var(--ink-subtle); cursor: pointer; transition: all 0.2s;
  }
  ...
  .pricing-card {
    ...
    display: flex; flex-direction: column; gap: 0; background: var(--cream);
  }
  .pricing-card.featured {
    background: var(--green-deep); border-color: transparent;
    box-shadow: 0 20px 60px rgba(27,67,50,0.25); position: relative;
  }
  .pricing-badge {
  ...
  .pricing-btn {
    width: 100%; padding: 13px; border-radius: 10px; border: 1.5px solid var(--border);
    background: transparent; color: var(--ink); font-family: 'Plus Jakarta Sans', sans-serif;
    font-size: 0.9rem; font-weight: 700; cursor: pointer; transition: all 0.2s; margin-top: auto;
  }
  ...
  /* ── TESTIMONIALS ─────────────────────────────────────────────────────── */
  /* Vaultify: big quote mark, 3-col masonry testimonial cards */
  ...
  .testimonials-quote-mark {
    ...
    color: var(--green-pale); font-weight: 900; display: block; margin-bottom: -20px;
  }
  ...
  /* ── CTA BANNER ───────────────────────────────────────────────────────── */
  /* Vaultify: dark full-width banner with headline + buttons + phone image */
  .cta-banner {
    background: var(--green-deep); padding: 80px 6%;
    position: relative; overflow: hidden;
  }
  .cta-banner-inner {
    max-width: 1200px; margin: 0 auto;
  ...
  .cta-headline {
    ...
    font-weight: 900; color: var(--white); line-height: 1.1; letter-spacing: -0.02em; margin-bottom: 16px;
  }
  ...
  .cta-btn-outline {
    ...
    border: 1.5px solid rgba(255,255,255,0.25); border-radius: 8px; padding: 13px 24px;
    font-family: 'Plus Jakarta Sans', sans-serif; font-size: 0.95rem; font-weight: 600;
    cursor: pointer; transition: all 0.2s;
  }
  ...
  .cta-avatar {
    width: 32px; height: 32px; border-radius: 50%; border: 2px solid var(--green-deep);
    display: flex; align-items: center; justify-content: center;
    font-size: 0.65rem; font-weight: 800; color: var(--white); margin-left: -8px;
  }
  .cta-avatar:first-child { margin-left: 0; }
  .cta-users-text { font-size: 0.82rem; color: rgba(255,255,255,0.55); }
  .cta-phone-slot {
    width: 220px; aspect-ratio: 9/18;
    background: rgba(255,255,255,0.06); border-radius: 24px;
    border: 1px dashed rgba(255,255,255,0.2);
    display: flex; flex-direction: column; align-items: center; justify-content: center;
    gap: 8px; color: rgba(255,255,255,0.3); font-size: 0.75rem; text-align: center;
    flex-shrink: 0;
  }
  @media(max-width:768px) { .cta-phone-slot { display: none; } }

  /* ── FOOTER ───────────────────────────────────────────────────────────── */
  /* Vaultify: 4-col footer with brand, product, company, connect */
  ...
  .footer-brand-name {
    font-family: 'Playfair Display', serif; font-size: 1.5rem; font-weight: 700;
    color: var(--white); display: flex; align-items: center; gap: 8px; margin-bottom: 14px;
  }
  ...
  .footer-col a {
    ...
    text-decoration: none; margin-bottom: 10px; cursor: pointer; transition: color 0.2s;
  }
  ...
  .footer-wordmark {
    ...
    font-weight: 900; color: rgba(255,255,255,0.04); text-align: center;
    display: block; margin-top: 48px; letter-spacing: -0.02em; line-height: 1;
    max-width: 1200px; margin-left: auto; margin-right: auto;
  }

  /* ═══════════════════════════════════════════════════════════════
     MOBILE — complete responsive overhaul for screens < 480px
  ═══════════════════════════════════════════════════════════════ */
  @media(max-width:480px) {
    ...
    .hero-eyebrow { font-size: 0.72rem; padding: 5px 12px; margin-bottom: 20px; }
    ...
    .how-right { order: -1; }
    .how-headline { font-size: 2rem; margin-bottom: 16px; }
    .how-sub { font-size: 0.875rem; margin-bottom: 0; }
    .how-steps { gap: 24px; }
    .how-step-num { width: 32px; height: 32px; font-size: 0.75rem; flex-shrink: 0; }
    .how-step-title { font-size: 0.95rem; }
    .how-step-desc { font-size: 0.82rem; }
    .how-steps .btn-primary { width: 100%; }

    /* PRICING */
    .pricing-section { padding: 60px 4%; }
    .pricing-toggle { width: 100%; }
    .pricing-toggle button { flex: 1; font-size: 0.82rem; padding: 8px 12px; }
    .pricing-grid { grid-template-columns: 1fr; max-width: 100%; gap: 16px; margin-top: 32px; }
    .pricing-card { padding: 24px; }
    .pricing-price { font-size: 2.2rem; }
    .pricing-btn { padding: 12px; font-size: 0.875rem; }

    /* TESTIMONIALS */
    .testimonials-section { padding: 60px 4%; }
    .testimonials-top { grid-template-columns: 1fr; gap: 24px; margin-bottom: 40px; }
    .testimonials-quote-mark { font-size: 5rem; margin-bottom: -10px; }
    .testimonials-headline { font-size: 1.75rem; }
    .testimonials-stats { gap: 24px; }
    .t-stat-val { font-size: 1.8rem; }
    ...
    .footer-brand-desc { font-size: 0.82rem; max-width: 100%; }
  ...
  @media(min-width:481px) and (max-width:768px) {
    ...
    .how-right { order: -1; }
    .how-headline { font-size: 2.4rem; }

    .cta-btns { flex-wrap: wrap; }
    .cta-phone-slot { display: none; }
    .footer-top { grid-template-columns: 1fr 1fr; }
    .footer-wordmark { font-size: 5rem; }
  }
`;
...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "Set ₦15,000 for food. We alert you before you break it — not after.",
  },
  {
    icon: "🏦",
    bg: "fi-ink",
...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Type it in plain language. Your 7-day Premium trial activates automatically.",
  },
];
...
export default function Landing() {
  ...
  return (
    <>
      ...
      {/* ── HERO ────────────────────────────────────────────────────── */}
      {/* Layout: headline left, phone image placeholder right */}
      <section className="hero">
        <div className="hero-inner">
          ...
          {/* Phone image slot — add your image here */}
      ...
      {/* ── STATS STRIP ─────────────────────────────────────────────── */}
      {/* Vaultify style: 4 metrics across a grey band */}
      ...
      {/* ── FEATURES ────────────────────────────────────────────────── */}
      {/* Vaultify: center header + 3-col card grid */}
        ...
        <div className="features-grid">
          {FEATURES.map((f, i) => (
            <div key={i} className="feature-card">
              ...
              <div className="feature-link" onClick={goToAuth}>
                Learn more →
              </div>
            </div>
          ))}
      ...
      {/* ── HOW IT WORKS ────────────────────────────────────────────── */}
      {/* Vaultify: steps list left, big headline right */}
      ...
      {/* ── PRICING ─────────────────────────────────────────────────── */}
      {/* Vaultify: 3-card grid — free, featured pro, business */}
      ...
      {/* ── TESTIMONIALS ────────────────────────────────────────────── */}
      {/* Vaultify: big quote + stats left, cards right */}
      ...
      {/* ── CTA BANNER ──────────────────────────────────────────────── */}
      {/* Vaultify: dark green banner with headline + buttons + phone slot */}
        ...
        <div className="cta-banner-inner">
          <div>
            ...
            <p className="cta-sub">
              ...
              access for your first 7 days automatically.
            </p>
      ...
      {/* ── FOOTER ──────────────────────────────────────────────────── */}
      {/* Vaultify: 4-col footer with big wordmark at bottom */}
