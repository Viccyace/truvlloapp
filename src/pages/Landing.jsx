...
const styles = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero-sub {
    margin-top: 24px; font-size: 1.125rem; color: var(--ink-subtle); line-height: 1.7;
    text-align: center; max-width: 560px; font-weight: 400;
  }
  ...
  .btn-primary {
    ...
    padding: 16px 36px; font-family: 'Plus Jakarta Sans', sans-serif;
  ...
  .btn-ghost {
    background: transparent; color: var(--ink-muted); border: 1.5px solid rgba(10,10,10,0.15);
  ...
  .hero-social-proof {
    ...
    font-size: 0.875rem; color: var(--ink-subtle);
  }
  .avatar-stack { display: flex; }
  .avatar-stack img, .avatar-placeholder {
    width: 34px; height: 34px; border-radius: 50%;
    border: 2px solid var(--cream); margin-left: -10px;
    object-fit: cover;
  }
  .avatar-placeholder {
  ...
  .dashboard-preview {
    ...
    padding: 24px; box-shadow: 0 40px 100px rgba(10,10,10,0.2), 0 0 0 1px rgba(255,255,255,0.06);
    position: relative;
  }
  .dp-header {
  ...
  .section-headline {
    ...
    line-height: 1.15; letter-spacing: -0.015em; max-width: 600px;
  }
  ...
  .ai-feature-card {
    background: rgba(255,255,255,0.04); border-radius: 20px; padding: 28px;
  ...
  .pricing-toggle button {
    ...
    font-family: 'Plus Jakarta Sans', sans-serif; font-size: 0.875rem; font-weight: 600; cursor: pointer; transition: all 0.2s;
  ...
  .pricing-card {
    ...
    border: 1.5px solid rgba(10,10,10,0.08); text-align: left; position: relative;
  }
  .pricing-card.featured {
    background: linear-gradient(160deg, var(--green-deep), var(--green-mid));
    border-color: transparent; color: var(--white);
    box-shadow: 0 20px 60px rgba(27,67,50,0.35);
  ...
  .pricing-badge {
    ...
    padding: 4px 16px; border-radius: 100px; font-size: 0.72rem; font-weight: 800;
  ...
  .pricing-btn.white { background: var(--white); color: var(--green-deep); border-color: transparent; }
  ...
  .step-num {
    ...
    display: flex; align-items: center; justify-content: center;
    font-family: 'Playfair Display', serif; font-size: 1.4rem; font-weight: 900; color: var(--white);
    background: linear-gradient(135deg, var(--green-deep), var(--green-light));
  ...
  .cta-section .blob-1 { opacity: 0.15; }
  ...
  .footer-love { color: rgba(255,255,255,0.3); }
...
const FEATURES = [
  { icon: "📊", color: "green", title: "Budget Pace", desc: "Know if you're spending too fast or on track — with a clear expected-vs-actual comparison updated daily." },
  { icon: "💡", color: "amber", title: "Safe-to-Spend", desc: "Your daily spending allowance based on what's left and how many days remain in your budget period." },
  { icon: "🔁", color: "ink", title: "Recurring Expenses", desc: "Set fixed costs like rent, subscriptions, and utilities once. Truvllo accounts for them automatically every month." },
  { icon: "📁", color: "green", title: "Category Caps", desc: "Set limits per category — food, transport, entertainment — and get warned before you overshoot." },
  { icon: "📤", color: "amber", title: "CSV Export", desc: "Download your full expense history any time. Useful for tax season, accountants, or just your peace of mind." },
  { icon: "🏆", color: "ink", title: "Habit Streaks", desc: "Stay consistent with daily logging streaks. A small nudge that builds a real money habit over time." },
];

const AI_FEATURES = [
  { icon: "🔍", title: "Spending Analyst", desc: "Plain-English breakdown of your spending patterns each week — no spreadsheets needed." },
  { icon: "💬", title: "Natural Language Entry", desc: 'Just type "spent 4500 on lunch at Chicken Republic" and Truvllo logs it. No forms.' },
  { icon: "🎯", title: "Savings Coach", desc: "One specific, data-driven tip each week on where you can actually cut back without suffering." },
  { icon: "🏷️", title: "Smart Categorisation", desc: "Type a merchant name and Truvllo suggests the right category instantly — learns your habits over time." },
  { icon: "📐", title: "Budget Advisor", desc: "Enter your income and a goal. The AI suggests a realistic monthly budget breakdown tailored to Nigeria." },
  { icon: "⚠️", title: "Overspend Explainer", desc: "When you're over pace, Truvllo tells you exactly why — and gives you specific cuts to get back on track." },
];

const TESTIMONIALS = [
  { quote: "Finally a budgeting app that feels built for me, not some American earning in dollars. The Naira support and local context makes all the difference.", name: "Adaeze O.", role: "Product Manager, Lagos", color: "#2D6A4F" },
  { quote: "The AI spending coach saved me ₦40k last month. It spotted I was overspending on food delivery before I even noticed.", name: "Korede F.", role: "Software Engineer, Abuja", color: "#1B4332" },
  { quote: "I've tried every budgeting app. None of them stuck. Truvllo is the first one where I've logged expenses for 3 months straight without missing a day.", name: "Temi A.", role: "Nurse, Port Harcourt", color: "#40916C" },
  { quote: "The Safe-to-Spend number is genius. I literally check it every morning before I leave the house.", name: "Oluwaseun B.", role: "Civil Servant, Ibadan", color: "#D4A017" },
  { quote: "The premium trial started automatically after my first expense. I didn't even realise I was using premium features — it just worked.", name: "Funmilayo K.", role: "Small Business Owner, Lagos", color: "#2D6A4F" },
  { quote: "Switched from another app and imported all my categories in minutes. The interface is honestly beautiful — it feels premium in a way that African apps rarely do.", name: "Emeka T.", role: "Investment Analyst, Victoria Island", color: "#1B4332" },
];

const FREE_FEATURES = ["Unlimited budgets & expense logs", "Budget pace indicator", "Safe-to-spend daily limit", "6 supported currencies", "Mobile-first PWA", "Basic charts & summaries"];
const PREMIUM_FEATURES = ["Everything in Free", "All 6 AI-powered features", "Category spending caps", "Recurring expense tracking", "Advanced charts & trends", "CSV export", "Habit streak tracking", "Priority support"];

const STEPS = [
  { title: "Create your account", desc: "Sign up in under 30 seconds. No credit card, no commitment. Your data is yours." },
  { title: "Set your budget", desc: "Enter your monthly income and choose your currency. Done. Truvllo handles the rest." },
  { title: "Log your first expense", desc: "Type it naturally or use the quick-add form. This unlocks your free 7-day premium trial instantly." },
  { title: "Watch your money make sense", desc: "AI insights, pace tracking, and daily spending limits — all working together from day one." },
];
    ...
    <>
      ...
      <section className="hero">
        ...
        <div className="hero-badge">
          ...
          AI-powered budgeting for West Africa
        </div>

        <h1 className="hero-headline playfair">
          Your money,<br /><em>finally making sense</em>
        </h1>

        <p className="hero-sub">
          Truvllo is the smart budget tracker built for young professionals in Nigeria. Know exactly what you can spend today, every day.
        </p>

        <div className="hero-actions">
          <button className="btn-primary">Start for free — no card needed</button>
        ...
        <div className="hero-social-proof">
          <div className="avatar-stack">
            {avatarColors.map((c, i) => (
              <div key={i} className="avatar-placeholder" style={{ background: c, marginLeft: i === 0 ? 0 : -10 }}>
                {avatarInitials[i]}
              </div>
            ))}
          </div>
          <span><strong style={{ color: "#0A0A0A" }}>2,400+</strong> Nigerians managing money smarter</span>
        </div>
        ...
        <div className="dashboard-preview">
          ...
          <div className="dp-cards">
            <div className="dp-card">
              ...
              <div className="dp-card-value">₦180,000</div>
            </div>
            <div className="dp-card">
              <div className="dp-card-label">Total Spent</div>
              <div className="dp-card-value red">₦112,400</div>
            </div>
            <div className="dp-card">
              <div className="dp-card-label">Remaining</div>
              <div className="dp-card-value green">₦67,600</div>
            </div>
            <div className="dp-card">
              <div className="dp-card-label">Safe-to-Spend</div>
              <div className="dp-card-value amber">₦4,507<span style={{ fontSize: "0.7rem", opacity: 0.6 }}>/day</span></div>
            </div>
          </div>
          ...
          <div className="dp-pace">
            ...
            <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.72rem", color: "rgba(255,255,255,0.4)", marginBottom: 8 }}>
              <span>Spent: ₦112,400</span>
              <span>Expected: ₦92,900</span>
            </div>
          ...
          <div className="dp-ai-row">
            <div className="dp-ai-card">
              ...
              <p className="dp-ai-text">Your food spending is 28% above last month — mostly weekend deliveries. Cooking 3x a week could save you ₦18,000.</p>
            </div>
            <div className="dp-ai-card">
              <div className="dp-ai-tag">
                <div className="dp-ai-dot" />
              ...
              <p className="dp-ai-text">Cut your Bolt usage by half this week and redirect ₦6,000 to your emergency fund — you're close to your 3-month goal.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section" style={{ background: "var(--cream)" }}>
        ...
        <h2 className="section-headline playfair">Everything you need. Nothing you don't.</h2>
        <p className="section-sub">Built around the real financial habits of young professionals in Lagos, Abuja, and beyond.</p>
      ...
      <section className="ai-section">
        ...
        <h2 className="section-headline playfair" style={{ color: "var(--white)" }}>
          Your personal<br /><em style={{ color: "rgba(255,255,255,0.6)" }}>financial intelligence</em>
        </h2>
        <p className="section-sub">Six AI tools that actually understand your spending — and tell you something useful, not generic.</p>
      ...
      <section className="testimonials-section">
        <div style={{ textAlign: "center" }}>
          ...
          <h2 className="section-headline playfair" style={{ margin: "0 auto" }}>Real people. Real results.</h2>
          <p className="section-sub" style={{ margin: "16px auto 0" }}>From Lagos to Abuja — here's what Truvllo users say after 90 days.</p>
        </div>
      ...
      <section className="pricing-section">
        ...
        <p className="section-sub">Start free. Upgrade when you're ready. Cancel any time.</p>

        <div className="pricing-toggle">
          <button className={billing === "monthly" ? "active" : ""} onClick={() => setBilling("monthly")}>Monthly</button>
          <button className={billing === "annual" ? "active" : ""} onClick={() => setBilling("annual")}>Annual <span style={{ color: "var(--green-mid)", fontWeight: 800 }}>−25%</span></button>
        </div>
        ...
        <div className="pricing-grid">
          ...
          <div className="pricing-card">
            ...
            <div className="pricing-price playfair">₦0<span>/forever</span></div>
            <p className="pricing-desc">For anyone ready to take their first step toward financial clarity.</p>
            <div className="pricing-divider" />
            <ul className="pricing-features">
              {FREE_FEATURES.map((f, i) => <li key={i}><span className="check">✓</span>{f}</li>)}
            </ul>
          ...
          <div className="pricing-card featured">
            ...
            <div className="pricing-plan playfair" style={{ color: "rgba(255,255,255,0.85)" }}>Premium</div>
            <div className="pricing-price playfair" style={{ color: "var(--white)" }}>
              ₦{price}<span style={{ color: "rgba(255,255,255,0.5)" }}>{period}</span>
            </div>
            <p className="pricing-desc">Full AI suite + advanced tools for serious money management.</p>
            <div className="pricing-divider" />
            <ul className="pricing-features">
              {PREMIUM_FEATURES.map((f, i) => <li key={i}><span className="check">✓</span>{f}</li>)}
            </ul>
            <button className="pricing-btn white">Start 7-day free trial</button>
          </div>

          {/* BUSINESS */}
          <div className="pricing-card coming-soon">
            <div className="pricing-plan playfair">Business</div>
            <div className="pricing-price playfair" style={{ fontSize: "1.8rem" }}>Coming Soon</div>
            <p className="pricing-desc">Team budgets, expense approvals, and financial oversight for growing businesses.</p>
            <div className="pricing-divider" />
            <ul className="pricing-features">
              {["Everything in Premium", "Team expense management", "Approval workflows", "Role-based access", "Finance dashboard", "Dedicated support"].map((f, i) => (
                <li key={i}><span className="check">✓</span>{f}</li>
              ))}
            </ul>
            <button className="pricing-btn disabled" disabled>Join the waitlist</button>
          </div>
        </div>

        <p style={{ marginTop: 32, color: "var(--ink-subtle)", fontSize: "0.875rem" }}>
          🎉 Your 7-day Premium trial starts <strong>automatically</strong> when you log your first expense — no card required.
        </p>
      </section>
      ...
      <section className="how-section">
        <div style={{ textAlign: "center" }}>
          ...
          <h2 className="section-headline playfair" style={{ margin: "0 auto" }}>Up and running in minutes.</h2>
          <p className="section-sub" style={{ margin: "16px auto 0" }}>No complicated setup. No financial jargon. Just clarity, fast.</p>
        </div>
      ...
      <section className="cta-section">
        ...
        <p>Join 2,400+ young Nigerians who've taken back control of their finances. Free to start, powerful from day one.</p>
        <button className="cta-btn">Create your free account</button>
        <p className="cta-trial-note">No credit card · 7-day Premium trial on first expense · Cancel any time</p>
      </section>
      ...
      <footer className="footer">
        <div className="footer-top">
          <div>
            ...
            <p className="footer-brand-desc">Smart budget tracking built for young professionals in Nigeria and West Africa. Know your money. Own your future.</p>
          </div>
        ...
        <div className="footer-bottom">
          <span className="footer-copy">© 2026 Truvllo. All rights reserved.</span>
          <span className="footer-love">Built with <span>♥</span> for Nigeria</span>
        </div>
      </footer>
    </>
  );
